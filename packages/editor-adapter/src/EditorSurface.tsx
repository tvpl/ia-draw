...
interface ExcalidrawSceneApi {
   ...
   * this interface (EDT-07/AD-008: no internal subpath import). Optional —
   * a mocked-in-test API that omits it is a legitimate degrade, never a crash
   * (`scrollToFrame` below calls it defensively).
   */
  scrollToContent?: (
    target: readonly SceneElement[],
