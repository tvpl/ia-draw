...
- **Next step**: R24 (`shared-resource-frame-fix`) e R27 (`concurrency-proof`) fechadas — ver marcos abaixo. R25 (`editor-panel-collapse`) é o próximo candidato natural para UIF-17.
