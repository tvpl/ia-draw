...
- **Proximo passo**: F6-F9 e agora **R1, R2 e R3 de F10** estão fechadas e verificadas. Próximo é **R4 (`workspace-members`)** — depende de R3 (feito). Ordem restante do roadmap depois de R4: R5/R6/R7 (paralelas entre si) → R8/R9/R10/R11 → R12 → R13/R14 → R15/R16.
