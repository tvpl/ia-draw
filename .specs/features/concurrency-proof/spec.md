...
| CCP-05 | P1: BOOT-08 provado contra concorrência real | Verified | ✅ Verified — 15 repetições internas por execução, sensor 15/15 execuções mataram a mutação (ver `validation.md`, Fix 1) |
| CCP-06 | P1: BOOT-08 provado contra concorrência real | Verified | ✅ Verified — mesma suíte de CCP-05 |
| CCP-07 | P1: BOOT-08 provado contra concorrência real | Verified | ✅ Verified — mesma suíte de CCP-05 |
