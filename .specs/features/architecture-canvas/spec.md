...
| VER-01 | P1: Snapshots e restore | F1 | Pending |
...
| LIB-01 | P1: Biblioteca e semântica | F2 | Pending |
...
| EXP-01 | P1: Export e salvamento local | F1 | Implementing |
...
| OPS-04 | P1: Backup com restore testado | F1 | Pending |
